+<template>
  ...
  >
    <div class="pt-32 pl-8 mb-2">
      <img src="@/assets/pocahontas-logo.png" alt="logo" class="w-96" />
    </div>
...
export default {
  ...
  data() {
    return {
      background: require("@/assets/pocahontas-bg.jpg"),
      items: undefined
    };
  },
  mounted() {
    Vue.axios.get("https://api.urecommend.me/media/10530").then(response => {
